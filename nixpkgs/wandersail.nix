...

{
  ...
  home.packages = with pkgs; [
    ...
    libreoffice
    # other desktop apps
    firefox-beta chromium evince thunderbird pdfpc signal-desktop
  ];
  ...
  programs.niri.settings = {
    ...
    # https://github.com/jgarza9788/niri-animation-collection/blob/main/animations/pixelate.kdl
    animations = {
      ...
      window-open = {
        kind.easing = { duration-ms = 400; curve = "linear"; };
        custom-shader = ''
