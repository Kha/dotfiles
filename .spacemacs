...
values."
  (setq-default
   ...
   dotspacemacs-additional-packages '() ;lean-mode company-lean helm-lean)
...
values."
  ...
  (setq-default
   ...
   dotspacemacs-default-font '("Iosevka" ;"Source Code Pro"
                               :size 15
                               :weight normal
                               :width normal
                               :powerline-scale 1.3)
...
you should place your code here."
  ...
  ;; https://github.com/syl20bnr/spacemacs/issues/6871
  (defun term-send-esc ()
