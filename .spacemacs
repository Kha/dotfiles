...
values."
  (setq-default
   ...
   dotspacemacs-additional-packages '(company dash dash-functional flycheck f fill-column-indicator s lua-mode mmm-mode)
   ;; A list of packages and/or extensions that will not be install and loaded.
   dotspacemacs-excluded-packages '(exec-path-from-shell smartparens)
...
you should place your code here."
  ...
  ;;(setq company-racer-executable "/home/sebastian/lib/racer/target/release/racer")
  (set-variable 'ycmd-server-command '("python2" "/home/sebastian/.vim/bundle/YouCompleteMe/third_party/ycmd/ycmd"))
  (global-ycmd-mode)
  (require 'company-ycmd)
  (global-company-mode)

  (setq lean-rootdir "~/projects/lean/lean")
